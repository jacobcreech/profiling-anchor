...
pub mod profile {
    ...
    /// CHECK: No additional type checks needed - AccountInfo is a raw account reference
    ...
    /// CHECK: No additional type checks needed - UncheckedAccount explicitly bypasses validation
